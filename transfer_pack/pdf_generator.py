...
STORAGE_DIR = Path(r"C:\dent_ai\storage")
STORAGE_DIR.mkdir(parents=True, exist_ok=True)

LOGO_PATH = Path(r"C:\dent_ai\logo_CS_vertical_blue.png")
LOGO_MAX_WIDTH = 120
LOGO_MAX_HEIGHT = 60
...
FONT_CANDIDATES = [
    ...
    (
        Path(r"C:/dent_ai/fonts/DejaVuSans.ttf"),
        Path(r"C:/dent_ai/fonts/DejaVuSans-Bold.ttf"),
        Path(r"C:/dent_ai/fonts/DejaVuSans-Oblique.ttf"),
        Path(r"C:/dent_ai/fonts/DejaVuSans-BoldOblique.ttf"),
    ),
    (
