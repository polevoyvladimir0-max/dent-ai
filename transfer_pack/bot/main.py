...
ALIASES_PATH = Path(r"C:\dent_ai\config\service_aliases.json")
...
VOICE_MODEL = WhisperModel("small", device="cpu", compute_type="int8_float32")
AUDIO_DIR = Path(r"C:\dent_ai\voice")
